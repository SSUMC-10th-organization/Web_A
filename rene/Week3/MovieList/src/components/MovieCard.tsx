...
const MovieCard = ({ movie }: Props) => {
  return (
    <div className="relative group rounded-xl overflow-hidden cursor-pointer">
      ...
      <div className="absolute inset-0 bg-black/80 text-white flex flex-col justify-center p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <p className="text-sm font-bold mb-2">{movie.title}</p>
        <p className="text-xs text-gray-300 line-clamp-4 leading-snug">
